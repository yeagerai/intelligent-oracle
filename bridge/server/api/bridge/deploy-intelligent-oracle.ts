...
export default defineEventHandler(async (event) => {
  try {
    ...
    const deploymentArgs = [
      ...
      body.title,
      body.description,
      Array.isArray(body.potentialOutcomes) ? body.potentialOutcomes.join(",") : body.potentialOutcomes,
      Array.isArray(body.rules) ? body.rules.join(",") : body.rules,
      Array.isArray(body.dataSourceDomains) ? body.dataSourceDomains.join(",") : body.dataSourceDomains,
      Array.isArray(body.resolutionURLs) ? body.resolutionURLs.join(",") : body.resolutionURLs,
